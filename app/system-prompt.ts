...
- original_price: The original price of the item, including any currency and units.
- converted_price: The price converted to user-specified currency. Use current exchange rates for conversion.
...
3. **Price Parsing**:
    - Extract the original price. Store this in the original_price field.
    - Convert the currency to user-specified currency.
...
5. **Output Structure**:
    - Each entry should be an object with the following structure:
    {
        ...
        "converted_price": "Price in Converted Currency",
